...
public class InterGestionarCategoria extends javax.swing.JInternalFrame {
    ...
    private void CargarTablaCategorias() {
        ...
        try {
            ...
            InterGestionarCategoria.TableCategorias = new JTable(model);
            InterGestionarCategoria.jScrollPane1.setViewportView(InterGestionarCategoria.TableCategorias);
        ...
        TableCategorias.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                int fila_point = TableCategorias.rowAtPoint(e.getPoint());
                int columna_point = 0;
